        ...
        <>
            <svg
                ...
                <g id="XMLID_3_">
                    <path
                        id="XMLID_4_"
                        className="st0 fill-current text-bg-sec-dark opacity-0 animate-logo-main"
                ...
                <polygon
                    id="XMLID_31_"
                    className="st4 fill-current text-sec dark:text-bg-sec-inverted transform-gpu translate-x-full opacity-0 animate-logo-center"
