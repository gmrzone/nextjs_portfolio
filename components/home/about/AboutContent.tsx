...
const AboutContent: NextPage = () => {
    ...
    return (
        <div
            ...
            data-name="content">
            <div className="">
                <h3 className="text-main dark:text-main-dark h-20">I am AFzal and I&apos;am a <span ref={typingText} className="text-action inline-block dark:text-blue-600 relative after:absolute after:w-1 after:-right-2 after:animate-type-text-cursor after:bg-black after:h-full"></span></h3>
