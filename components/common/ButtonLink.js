    ...
    return (
        <a
            ...
            className={`${
                ...
                icon && "space-x-2"
            } ${action ? "bg-action hover:bg-action-hover dark:bg-blue-600 dark:text-bg-sec-inverted dark:hover:bg-blue-900" : "bg-sec dark:bg-bg-sec-dark dark:hover:bg-bg-sec-inverted hover:bg-blue-700"} hover:text-white sm:self-start ${
