    ...
    return (
        <div className="w-14">
            ...
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 567 500" style={{enableBackground:"new 0 0 567 500"}} xmlSpace="preserve">
                <g id="XMLID_3_">
                    <path id="XMLID_4_" className="st0" d="M51.7,387L12.4,495H132l34.2-108H51.7z M321.7,4.9H190.8L84.5,297h107l52-161.9
