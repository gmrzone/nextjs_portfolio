        ...
        <div className="w-14 cursor-pointer">
            ...
            <svg
                ...
                <g id="XMLID_3_">
                    <path
                        id="XMLID_4_"
                        className="st0 fill-current text-main dark:text-bg-sec-inverted"
                ...
                <polygon id="XMLID_31_" className="st4 fill-current text-sec dark:text-bg-sec-dark" points="558,378 54.1,378 79.5,306 530.2,306 " />
            </svg>
        </div>
    );
};
