...
const ThemeSwitcher = () => {
    ...
    return (
        <div className={`relative border border-solid bg-white rounded-full transition duration-300 ${darkThemeActive ? "border-blue-400" : "border-gray-400"} ${style['theme-switcher__container']}`}>
